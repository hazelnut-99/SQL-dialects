...
for host_db in ["click"]:
    ...
    for collection in collections:
        ...
        for guest_db in all_dbs:
            ...
            guest_db_instance = get_database_instance(guest_db, db_name + "_" + host_db)
            ...
            for test_case in test_cases:
                if guest_result[test_case].result_type == RunResultType.ERROR:
                    compare_result_detail = {
                        ...
                        "error_stage": guest_result[test_case].fail_stage.value
                    }
